...
* Ethereum is the name of the network (blockchain) that Ether runs on. 
* Ether (or ETH) refers to the cryptocurrency that runs on the Ethereum network. 
* These two terms are commonly (incorrectly) used interchangeably.
...
* A digital asset that exists on a blockchain but is not the main cryptocurrency of that blockchain. 
* Examples of tokens that exist on the Ethereum blockchain are BAT, DAI, and OMG. 
